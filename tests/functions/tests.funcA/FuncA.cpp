...
BEGIN_SIGNATURE_HOOK
  DECLARE_SIGNATURE_ID(("tests.funcA"));
  DECLARE_SIGNATURE_NAME(("test function A"));
...
*/
class FunctionA : public openfluid::base::PluggableFunction
{
  private:
...
DEFINE_FUNCTION_HOOK(FunctionA)
