...
#' Returns all the variables names generated by a generator
#'
#' @param ofblob the simulation definition blob
#' @param unitclass the units class
...
OpenFLUID.getGeneratorsVarNames <- function(ofblob,unitclass)
{
  ...
  ret <- .Call("GetGeneratorsVarNames", ofblob, unitclass, PACKAGE="ROpenFLUID")
...
#' Returns all the parameters of a generator
#'
#' @param ofblob the simulation definition blob
...
OpenFLUID.getGeneratorParamNames <- function(ofblob, unitclass, varname)
{
  ...
  ret <- .Call("GetGeneratorParamNames", ofblob, unitclass, varname, PACKAGE="ROpenFLUID")
...
#' Returns all the parameters of an observer
#'
#' @param ofblob the simulation definition blob
#' @param obsid the observer ID
#' @return a vector of parameters names
